    ...
    <main class="flex-grow flex items-center justify-center p-4 md:p-8">
        ...
        <div class="bg-white w-full max-w-2xl rounded-[2.5rem] shadow-xl p-8 md:p-14 transition-all">
            ...
            <div class="mt-8 md:mt-12 flex flex-col-reverse md:flex-row gap-4 justify-center">
                <a href="{{ route('terima.kasih') }}" class="w-full md:w-auto px-10 py-3.5 border-2 border-[#b54a3a] text-[#b54a3a] font-bold rounded-2xl hover:bg-red-50 transition-colors text-center text-[15px]">
                    Tidak Setuju
                </a>
